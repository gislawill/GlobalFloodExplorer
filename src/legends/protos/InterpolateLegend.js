...
export default function InterpolateLegend({
    ...
    console.log([
        ...[...Array(legend.breaks.length - 1).keys()].map(i => legend.breaks[i] / max_break),
        1
    ])
    ...
    return <div className='legend-item'>
        ...
        <svg
            ...
            <rect
                ...
                height="90%"
                fill="url(#gradient)" />
            {[breaks_as_perc[0], breaks_as_perc[breaks_as_perc.length -1]].map(b => <text
                x={xTextOffs}
